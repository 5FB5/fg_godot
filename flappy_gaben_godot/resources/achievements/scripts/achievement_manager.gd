...
const ACHIEVEMENT_DATA_SCRIPT_ADDRESS = "res://resources/achievements/scripts/achievement_data.gd"
const ACHIEVEMENT_UI_NOTIFICATION_ADDRESS = "res://resources/achievements/resources/game_ui/ui_achievements_notification.tscn"
